      ...
      {OPTIONS.map((option) => {
        ...
        return (
          <button
            ...
            className={clsx(
              "flex h-20 w-[100px] flex-col items-center justify-center gap-1.5 rounded-lg border text-sm font-medium transition-colors",
              "focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-500",
              selected ? "border-brand-400 bg-brand-50 text-brand-700" : "border-line text-gray-900 hover:bg-raised",
            )}
          >
